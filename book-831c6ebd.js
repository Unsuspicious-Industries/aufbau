...
// Register the 'spec' language for P7 grammar specifications
hljs.registerLanguage('spec', function(hljs) {
    return {
        name: 'Spec',
        aliases: ['spec'],
        ...
        contains: [
            ...
            // Horizontal rule for typing rules (must come before operators)
            {
                className: 'meta',
                begin: /^-{4,}/,
                end: /$/,
                contains: [
                    // Rule name in parentheses at end of line
                    {
                        className: 'title',
                        begin: /\(/,
                        end: /\)/,
            ...
            // Single-quoted string literals (terminals)
            {
                className: 'string',
                begin: /'/,
                end: /'/,
            ...
            // Double-quoted string literals (terminals)  
            {
                className: 'string',
                begin: /"/,
                end: /"/,
            ...
            // Rule name annotation on productions: (rule_name)
            {
                className: 'title',
                begin: /\([a-z_][a-z_0-9]*\)/
            },
            
            // Bindings in brackets: [name]
            {
                className: 'attr',
                begin: /\[/,
                end: /\]/,
                ...
                contains: [
                    {
                        className: 'variable',
                        begin: /[a-zA-Zα-ωΑ-Ω₀-₉][a-zA-Z0-9α-ωΑ-Ω₀-₉_]*/
                    }
                ]
            },
            ...
            // Arrow operators (function type, context extension)
            {
                className: 'keyword',
                begin: /→|->|⊢|⊆/
            },
            ...
            // Nonterminals (PascalCase identifiers)
            {
                className: 'type',
                begin: /\b[A-Z][a-zA-Z0-9]*\b/
            },
            
            // Context operations Γ(...) or Γ[...]
            {
                className: 'built_in',
                begin: /Γ\s*[\(\[]/,
                end: /[\)\]]/,
                contains: [
                    {
                        className: 'variable',
                        begin: /[a-zA-Zα-ωτσ][a-zA-Z0-9α-ω]*/
                    },
                    {
                        className: 'keyword',
                        begin: /:/
