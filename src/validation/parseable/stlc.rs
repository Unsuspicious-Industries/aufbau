...
fn left_recursive_application_tests() {
    ...
    let cases = vec![
        ...
        // Note: Parenthesized partial expressions are not currently supported
        // ParseTestCase::valid("paren left app", "(f x)"),
        // ParseTestCase::valid("nested paren left app", "((f x) y)"),
    ];
