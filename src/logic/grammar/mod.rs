...
pub enum Symbol {
    Simple { value: String, binding: Option<String>, repetition: Option<RepetitionKind> },
...
impl Symbol {
    pub fn new(value: String) -> Self { Self::Simple { value, binding: None, repetition: None } }
    pub fn with_binding(value: String, binding: String) -> Self { Self::Simple { value, binding: Some(binding), repetition: None } }
    pub fn with_repetition(value: String, repetition: RepetitionKind) -> Self { Self::Simple { value, binding: None, repetition: Some(repetition) } }
