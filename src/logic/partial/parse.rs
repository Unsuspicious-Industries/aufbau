    ...
    fn parse_symbol(
        ...
        match symbol {
            ...
            Symbol::Group {
                ...
                debug_trace!(
                    "parser",
                    "Parsing group of {} symbols",
                    symbols.len()
                );
                // Parse the group exactly once using the unified method
                let step =
