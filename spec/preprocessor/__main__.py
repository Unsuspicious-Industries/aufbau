...
from mermaid import process as process_mermaid
...
if __name__ == "__main__":
    ...
    if isinstance(book, dict) and "sections" in book:
        ...
        and "book" in book
        and isinstance(book["book"], dict)
        and "sections" in book["book"]
    ):
        ...
        print(
            f"preprocessor: unexpected book keys: {list(book.keys())}", file=sys.stderr
        )
